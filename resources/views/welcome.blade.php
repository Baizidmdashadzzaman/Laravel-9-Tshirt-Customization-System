...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Laravel 9 : Online Designer Prints For T-shirts</title>
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body class="antialiased preview "  data-spy="scroll" data-target=".subnav" data-offset="80">
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-12xl mx-auto sm:px-6 lg:px-8" style="padding-top:50px">
                            ...
                            <div class="container">
                                <section id="typography">
                                    <div class="page-header">
                                        <h3>Laravel 9 : Online Designer Prints For T-shirts</h3>
                                    </div>
                                        ...
                                        <div class="span4">
                                            ...
                                            <div class="tabbable"> <!-- Only required for left/right tabs -->
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li><a href="#tab2" data-toggle="tab">Engraver</a></li>
                                                </ul>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    ...
                    <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                        <font style="color:black">Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})</font>
                    </div>
                </div>
            </div>
        </div>
